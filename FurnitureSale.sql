...
CREATE TABLE nhan_vien (
	...
	FOREIGN KEY (id_loai_nhan_vien) REFERENCES loai_nhan_vien(id_loai_nhan_vien)
);
...
CREATE TABLE phieu_nhap (
    id_phieu_nhap NVARCHAR(36) PRIMARY KEY,
    ngay_nhap DATE,
    id_nhan_vien NVARCHAR(36),
    tong_tien FLOAT,
...
INSERT INTO hoa_don (id_hoa_don, id_khach_hang, ngay_dat, ngay_giao_hang, tinh_trang_thanh_toan, phuong_thuc_thanh_toan, tinh_trang_giao_hang, tong_tien) VALUES
    ('HD001', 'KH001', '2024-11-01', '2024-11-05', 1, 0, 1, 5000000),
    ('HD002', 'KH002', '2024-11-02', '2024-11-06', 1, 1, 1, 2500000),
    ('HD003', 'KH003', '2024-11-03', '2024-11-07', 0, 0, 0, 7000000),
    ('HD004', 'KH004', '2024-11-04', '2024-11-08', 1, 1, 1, 1200000),
    ('HD005', 'KH005', '2024-11-05', '2024-11-10', 1, 0, 0, 8000000),
    ('HD006', 'KH006', '2024-11-06', '2024-11-11', 0, 1, 1, 4500000),
    ('HD007', 'KH007', '2024-11-07', '2024-11-12', 1, 0, 1, 3000000),
    ('HD008', 'KH008', '2024-11-08', '2024-11-13', 0, 1, 0, 2000000),
    ('HD009', 'KH009', '2024-11-09', '2024-11-14', 1, 0, 1, 6000000),
...
INSERT INTO phieu_nhap (id_phieu_nhap, ngay_nhap, id_nhan_vien, tong_tien, ghi_chu) VALUES
    (N'PN001', '2024-12-01', N'NV003', 15000000, N'Nhập hàng đầu tháng 12'),
    (N'PN002', '2024-12-05', N'NV007', 8000000, N'Nhập bổ sung hàng hóa'),
    (N'PN003', '2024-12-10', N'NV003', 12000000, N'Nhập hàng dịp cuối năm'),
    (N'PN004', '2024-12-15', N'NV007', 20000000, N'Nhập hàng bán dịp lễ'),
    (N'PN005', '2024-12-20', N'NV003', 18000000, N'Nhập thêm hàng dự trữ');


INSERT INTO chi_tiet_phieu_nhap (id_phieu_nhap, id_san_pham, so_luong, don_gia, thanh_tien) VALUES
    -- Chi tiết cho PN001
    (N'PN001', N'SP001', 10, 15000000, 150000000),
    (N'PN001', N'SP005', 20, 3000000, 60000000),

    -- Chi tiết cho PN002
    (N'PN002', N'SP007', 15, 2000000, 30000000),
    (N'PN002', N'SP008', 5, 5000000, 25000000),

    -- Chi tiết cho PN003
    (N'PN003', N'SP009', 8, 12000000, 96000000),
    (N'PN003', N'SP002', 12, 18000000, 216000000),

    -- Chi tiết cho PN004
    (N'PN004', N'SP010', 10, 18000000, 180000000),
    (N'PN004', N'SP011', 20, 5000000, 100000000),

    -- Chi tiết cho PN005
    (N'PN005', N'SP003', 5, 22000000, 110000000),
    (N'PN005', N'SP012', 10, 7000000, 70000000);
